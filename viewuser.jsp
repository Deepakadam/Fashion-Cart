    ...
    <script>
        function confirmDelete(userId) {
            if (confirm("Are you sure you want to delete this user?")) {
                window.location.href = "deluser.jsp?user_id=" + userId;
            }
        }
    </script>
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item"><a class="nav-link" href="designer_home.jsp">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="designerviewcart.jsp">Orders</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto col-12">
                        <h2 class="hero-title text-center mb-5">All Users</h2>
                                ...
                                <center>
                                    <table border="2" cellpadding="10" cellspacing="4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" onclick="confirmDelete('<%= rs.getString(1) %>')">Delete</a>
                                            </td>
                                        </tr>
                                        <%
                                            }
