                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <h2 class="hero-title text-center mb-5">Store Details </h2>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    ...
                                    <%
                                       ResultSet rs=stmt.executeQuery("select * from storedetails");
                                       while(rs.next())
                                      {
                                    %>
                                        ...
                                        <tr>
                                          ...
                                          <td><a href="delstore.jsp?storeid=<%=rs.getString(1)%>"> Delete </a> </td>
                                        </tr>
