                                ...
                                <!-- <div class="col-lg-8 col-11 mx-auto">  -->
                                    ...
                                    %>
                                        ...
                                        <tr>
                                          ...
                                          <td><img src="./upload/<%=rs.getString(5) %>" width=200 height=200 /> </td>
                                          <td><a href="delproduct.jsp?product_id=<%=rs.getString(1)%>"> Delete </a> </td>
                          
                                          <!-- <td><a href="cartdetails.jsp?pid=<%=rs.getString(4)%>"> Order </a> </td> -->
                                        </tr>
                                    <%
                                      }
                                    %>
